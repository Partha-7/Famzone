import {
  ...
  useTheme
} from "./chunk-KCJRKKUG.js";
import {
  ClickAwayListener_default,
  useSlotProps,
  useSnackbar
} from "./chunk-D4M4L4Q3.js";
import {
  alpha,
  capitalize,
  chainPropTypes,
...
var SnackbarContent = React9.forwardRef(function SnackbarContent2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiSnackbarContent"
  });
...
var Snackbar = React10.forwardRef(function Snackbar2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiSnackbar"
  });
  ...
  return (0, import_jsx_runtime5.jsx)(ClickAwayListener_default, _extends({
    ...
    children: (0, import_jsx_runtime5.jsx)(SnackbarRoot, _extends({}, rootProps, {
      children: (0, import_jsx_runtime5.jsx)(TransitionComponent, _extends({
        ...
        children: children2 || (0, import_jsx_runtime5.jsx)(SnackbarContent_default, _extends({
          message,
          action
        }, ContentProps))
      }))
...
true ? Snackbar.propTypes = {
  ...
  anchorOrigin: import_prop_types10.default.shape({
    horizontal: import_prop_types10.default.oneOf(["center", "left", "right"]).isRequired,
   ...
   * @default null
   */
  autoHideDuration: import_prop_types10.default.number,
  /**
   ...
   */
  ClickAwayListenerProps: import_prop_types10.default.object,
  /**
   ...
   * @default false
   */
  disableWindowBlurListener: import_prop_types10.default.bool,
  /**
   ...
   */
  resumeHideDuration: import_prop_types10.default.number,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
//# sourceMappingURL=chunk-G2D6Q3FU.js.map
